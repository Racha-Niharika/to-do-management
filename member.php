...
<body>
    ...
    <nav>
            <form method="GET">
                ...
                <input type="text" name="search" id="s-bar" placeholder="Enter task name" value="<?php echo $searchTerm; ?>">
...
$searchCondition = $searchTerm != '' ? "AND name LIKE '%$searchTerm%'" : '';


// Fetch only task names associated with the logged-in team member's email
